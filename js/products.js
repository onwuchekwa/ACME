...
function buildProductList(data) { 
    ...
    let dataTable = '<thead>'; 
    dataTable += '<tr><th>Product Name</th><th>&nbsp;</th><th>&nbsp;</th></tr>'; 
    dataTable += '</thead>'; 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<td><a href='/acme/products?action=mod&id=${element.invId}' title='Click to modify ${element.invName}'>Modify</a></td>`; 
     dataTable += `<td><a href='/acme/products?action=del&id=${element.invId}' title='Click to delete ${element.invName}'>Delete</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
